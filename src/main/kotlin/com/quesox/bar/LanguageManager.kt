        ...
        when (language) {
            Language.EN_US -> {
                translations.putAll(mapOf(
                    ...
                    "backupalwaysright.multi_backup" to "Multi-threaded backup: %1\$s",
                    ...
                    "backupalwaysright.multi_backup_status" to "Multi-threaded backup: %1\$s"
                ))
            }
            Language.ZH_CN -> {
                translations.putAll(mapOf(
                    ...
                    "backupalwaysright.multi_backup" to "多线程备份: %1\$s",
                    ...
                    "backupalwaysright.multi_backup_status" to "多线程备份: %1\$s"
                ))
            }
            else -> {
                // 默认使用英文
